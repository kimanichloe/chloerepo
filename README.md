...
<head>
    ...
    <style>
        ...
        a {
            color: #00ff11;
            text-decoration: rgb(150, 226, 43);
        }
        a:hover {
...
<body>
    ...
    <section id="about">
        ...
        <p>Although i am new to tech and fresh out of highscool, I believe that i am capable of learning and improving my skills.And i am glad i can do that with this amazing opportunity granted to me by plp Academy.</p>
    </section>

    <section id="languages">
        <h2>Programming Languages i am vast with</h2>
        <ul>
            <li>Python</li>
            <li>SQL</li>
            <li>HTML/CSS</li>
    ...
    <section id="education">
        ...
        <p>i am a highschool graduate of the year 2024 from The Moi Forces Academy in Nakuru, Kenya.</p>
        <p><a href="my cv.docx" download>Download CV</a></p>
    </section>
    ...
    <section id="projects">
        ...
        <ul>
            <li>
                <a href="file:///C:/Users/w/Downloads/feb%202025%20c0hort/web%20development/week%20two/index.html">Project 1: Web Application</a> - A website build using html.></a>
            </li>
        </ul>
    </section>
    ...
    <section id="contact">
        <h2>Contact Me</h2>
        <form action="chloe.wanjiruk'gmail.com" method="post" enctype="text/plain">
